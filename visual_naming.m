...
%   4. Response
    ...
    % Ready
    prompt(win, char("If you see a green circle, watch/listen for an object"...
        +" and repeat the name of that object at the subsequent 'Speak'"...
        +" cue. If you see a red circle, watch/listen without repeatin"...
        +"g."),58);
